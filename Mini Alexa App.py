...
def run_alexa():
    ...
    try:
        ...
        if 'hello'  in command :
            ...
            engine_talk('hello, how can i helpp you ??')
           
        elif 'who are you' in command :
            print('I am alexa a k a your virtual assistant master')
            engine_talk('I am alexa a k a your virtual assistant master. how can i help you ??')
   
        elif 'can you do' in command :
            print('i can play songs on youtube , tell you a joke, search on wikipedia, tell the time, open different websites like insta gram, youtube,gmail, git hub, stack overflow and searches on google.How may i help you ??')
            engine_talk('i can play songs on youtube , tell you a joke, search on wikipedia, tell the time, open different websites like insta gram, youtube,gmail, git hub, stack overflow and searches on google. How may i help you ??')
...
print("hello i am alexa how can i help you ??")
